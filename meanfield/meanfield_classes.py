...
from meanfield.sources.Synapses import Synapse
...
def setup_brunel99_nmda():
    ...
    source_e_noise1 = MFStaticSource('E_noise1', pop_e1, params_standard['E']['Cext'], params_standard['E']['nu_ext'], {
    ...
    source_e_noise2 = MFStaticSource('E_noise2', pop_e2, params_standard['E']['Cext'], params_standard['E']['nu_ext'], {
        SP.GM: params_standard['E']['gAMPA'],
        SP.VREV: 0 * mV,
        SP.TAU: params_standard['E']['tau_AMPA'],
    })
    ...
    source_i_noise = MFStaticSource('I_noise', pop_i, params_standard['I']['Cext'], params_standard['I']['nu_ext'], {
    ...
    source_ee_nmda2 = MFLinearSource('EE Nmda2', pop_e2, {
        SP.GM: params_standard['E']['gNMDA'],
        SP.VREV: 0 * mV,
        SP.TAU: syn_spec_nmda['tau_syn_d1'],
        SP.W: w_min
    }, from_pop=pop_e1)#, synapse=syn_ee_nmda)
    source_ee_nmda22 = MFLinearSource('EE Nmda22', pop_e2, {
        SP.GM: params_standard['E']['gNMDA'],
        SP.VREV: 0 * mV,
        SP.TAU: syn_spec_nmda['tau_syn_d1'],
    ...
    source_ie_nmda = MFLinearSource('IE Nmda', pop_i, {
        SP.GM: params_standard['I']['gNMDA'],
        SP.VREV: 0 * mV,
        SP.TAU: syn_spec_nmda['tau_syn_d1'],
        SP.W: 1
    }, from_pop=pop_e1)#, synapse=syn_ie_nmda)
    source_ie_nmda2 = MFLinearSource('IE Nmda2', pop_i, {
        SP.GM: params_standard['I']['gNMDA'],
        SP.VREV: 0 * mV,
        SP.TAU: syn_spec_nmda['tau_syn_d1'],
        SP.W: 1
    ...
    source_ei_gaba1 = MFLinearSource('EI Gaba', pop_e1, {
    ...
    source_ei_gaba2 = MFLinearSource('EI Gaba', pop_e2, {
        SP.GM: params_standard['E']['gGABA'],
        SP.VREV: -70 * mV,
        SP.TAU: syn_spec_gaba['tau_syn_d1'],
    }, from_pop=pop_i)#, synapse=syn_ei_gaba)
...
def setup_EI(has_nmda=False):
    ...
    # noise pops
    source_e_noise = MFStaticSource('E_noise', pop_e, params_standard['E']['Cext'], params_standard['E']['nu_ext'], {
        SP.GM: params_standard['E']['gAMPA'],
        SP.VREV: 0 * mV,
        SP.TAU: params_standard['E']['tau_AMPA'],
    })
    ...
    source_ee_nmda = MFLinearSource('EE Nmda', pop_e, {
    ...
    # I->E GABA
    syn_ei_gaba = Synapse(**syn_spec_gaba)
    source_ei_gaba = MFLinearSource('EI Gaba', pop_e, {
        SP.GM: params_standard['E']['gGABA'],
        SP.VREV: -70 * mV,
        SP.TAU: syn_spec_gaba['tau_syn_d1'],  # not sure
    }, from_pop=pop_i)#, synapse=syn_ei_gaba)
